...
export const MENU_ITEMS: MenuItem[] = [
  ...
  // ===================== GUEST MENU / ΜΕΝΟΥ ΦΙΛΟΞΕΝΙΑΣ =====================
  // ΟΡΕΚΤΙΚΑ / STARTERS
  {
    id: 'guest-1',
    nameEn: 'Grilled Corn & Whole-Grain Pitas',
    nameEl: 'Ψητές Πίτες Καλαμποκιού & Ολικής',
    descriptionEn: 'Freshly grilled corn and whole-grain pitas, drizzled with cold-pressed olive oil and fresh oregano.',
    descriptionEl: 'Φρεσκοψημένες πίτες καλαμποκιού και ολικής άλεσης με ελαιόλαδο και φρέσκια ρίγανη.',
    price: 4,
    image: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Starters',
  ...
  },
  {
    ...
    nameEn: 'Avocado Tzatziki',
    nameEl: 'Τζατζίκι Αβοκάντο',
    descriptionEn: '100% Cretan avocado with cucumber, organic black garlic.',
    descriptionEl: '100% αβοκάντο Κρήτης, αγγούρι, βιολογικό μαύρο σκόρδο.',
    price: 10,
    image: 'https://images.unsplash.com/photo-1574894709920-11b28e7367e3?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Starters',
  ...
  },
  {
    ...
    nameEn: 'White Tarama Mousse',
    nameEl: 'Μους Λευκού Ταραμά',
    descriptionEn: 'Symian shrimp and Messolonghi bottarga mousse with herb-infused oil.',
    descriptionEl: 'Γαριδάκι Συμιακό, αυγοτάραχο Μεσολογγίου, λάδι μυρωδικών.',
    price: 11,
    image: 'https://images.unsplash.com/photo-1476224203421-9ac39bcb3327?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Starters',
  ...
  },
  {
    ...
    nameEn: 'Tuna Tartare',
    nameEl: 'Ταρτάρ Τόνου',
    descriptionEn: 'Premium tuna tartare with citrus sauce, pistachios and hot pepper threads.',
    descriptionEl: 'Σάλτσα εσπεριδοειδών, φιστίκι, ίνες καυτερής πιπεριάς.',
    price: 17,
    image: 'https://images.unsplash.com/photo-1626645738196-c2a7c87a8f58?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Starters',
  ...
  },
  {
    ...
    nameEn: 'Sea Bass Carpaccio',
    nameEl: 'Καρπάτσιο Λαβράκι',
    descriptionEn: 'Thinly sliced sea bass in village-salad broth, chives, pepper and fresh thyme.',
    descriptionEl: 'Ζωμός χωριάτικης σαλάτας, σχοινόπρασο, πιπεριά, θυμάρι.',
    price: 17,
    image: 'https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Starters',
  ...
  },
  {
    ...
    nameEn: 'Triple-Cooked Naxos Potatoes',
    nameEl: 'Πατάτες Νάξου Τριπλομαγειρεμένες',
    descriptionEn: 'Naxos potatoes with Monemvasia goat cheese cream, black truffle oil, smoked paprika and sea salt.',
    descriptionEl: 'Κρέμα κατσικίσιου τυριού Μονεμβασιάς, λάδι μαύρης τρούφας, πάπρικα καπνιστή, ανθός αλατιού.',
    price: 10,
    image: 'https://images.unsplash.com/photo-1541592106381-b31e9677c0e5?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Starters',
  ...
  },
  {
    ...
    nameEn: 'Open Spanakopita',
    nameEl: 'Σπανακόπιτα Ανοιχτή',
    descriptionEn: 'Village-style filo with feta, fresh herbs, Dodoni yogurt and olive oil earth.',
    descriptionEl: 'Χωριάτικο φύλλο, φέτα, φρέσκα μυρωδικά, γιαούρτι Δωδώνης, χώμα ελαιόλαδου.',
    price: 11.5,
    image: 'https://images.unsplash.com/photo-1490645935967-10de6ba17061?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Starters',
  ...
  },
  {
    ...
    nameEn: 'Feta Loukoumades',
    nameEl: 'Λουκουμάδες Φέτας',
    descriptionEn: 'Crispy feta fritters with spicy tomato jam and Chios mastic foam.',
    descriptionEl: 'Πικάντικη μαρμελάδα ντομάτας, αφρός μαστίχας Χίου.',
    price: 11.5,
    image: 'https://images.unsplash.com/photo-1551024601-bec78aea704b?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Starters',
  ...
  },
  {
    ...
    nameEn: 'Vegan Gyros (×2)',
    nameEl: 'Vegan Γύρος (2τμχ)',
    descriptionEn: 'Crispy legume cones with avocado tzatziki, fresh tomato and spring onion.',
    descriptionEl: 'Τραγανά χωνάκια οσπρίων, τζατζίκι αβοκάντο, ντομάτα, φρέσκο κρεμμύδι.',
    price: 9.5,
    image: 'https://images.unsplash.com/photo-1565557623262-b51c2513a641?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Starters',
  ...
  },
  {
    ...
    nameEn: 'Seafood "Pastitsio"',
    nameEl: '"Παστίτσιο" Θαλασσινών',
    descriptionEn: 'Crispy rice sheets with shrimp, sea bream, squid, tomato sauce, béchamel and baked graviera.',
    descriptionEl: 'Τραγανά φύλλα ρυζιού, γαρίδα, τσιπούρα, καλαμάρι, σάλτσα ντομάτας, μπεσαμέλ, γραβιέρα.',
    price: 13.5,
    image: 'https://images.unsplash.com/photo-1603360946369-dc9bb6258143?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Starters',
  ...
  // ΣΑΛΑΤΕΣ / SALADS
  {
    ...
    nameEn: 'Greek Village Salad',
    nameEl: 'Ελληνική Σαλάτα',
    descriptionEn: 'Cherry tomatoes, feta, cucumber, spring onion, olives, capers, carob rusks and sun-dried tomato dressing.',
    descriptionEl: 'Ντοματίνια, φέτα, αγγούρι, φρέσκο κρεμμύδι, ελιά, κάπαρη, παξιμάδια χαρουπιού, σάλτσα λιαστής ντομάτας.',
    price: 13.5,
    image: 'https://images.unsplash.com/photo-1540420773420-3366772f4999?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Salads',
  ...
  },
  {
    ...
    nameEl: 'Κυκλαδίτικη Σαλάτα',
    descriptionEn: 'Tender salad leaves, sour apple, Mykonos louza, Naxos graviera crumble, sunflower seeds, black raisin and citrus dressing.',
    descriptionEl: 'Τρυφερά φύλλα, ξυνόμηλο, λούτζα Μυκόνου, κράμπλ γραβιέρας Νάξου, ηλιόσποροι, μαύρη σταφίδα.',
    price: 14,
    image: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Salads',
  ...
  },
  {
    ...
    nameEl: 'Θαλασσινή Σαλάτα',
    descriptionEn: 'Tempura shrimp, squid, iceberg, cherry tomatoes, boiled egg, Evrytania prosciutto and anchovy dressing.',
    descriptionEl: 'Γαρίδα τεμπούρα, καλαμάρι, άισμπεργκ, ντοματίνια, βραστό αυγό, προσούτο Ευρυτανίας, σάλτσα αντζούγιας.',
    price: 15,
    image: 'https://images.unsplash.com/photo-1559847844-5315695dadae?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Salads',
  ...
  // ΚΥΡΙΩΣ / MAINS
  {
    ...
    nameEn: 'Cretan Skioufihta Pasta',
    nameEl: 'Σκιουφιχτά Κρήτης',
    descriptionEn: 'Handmade Cretan pasta with chicken, aged anthotyros and roasted tomato-pepper sauce.',
    descriptionEl: 'Χειροποίητα ζυμαρικά Κρήτης, κοτόπουλο, ξηρός ανθότυρος, σάλτσα ψητής ντομάτας-πιπεριάς.',
    price: 16,
    image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Mains',
  ...
  },
  {
    ...
    nameEn: 'Angel Hair Pasta with Seafood',
    nameEl: 'Ζυμαρικά Αγγέλων',
    descriptionEn: 'Clams, mussels, saffron from Kozani and chives.',
    descriptionEl: 'Αχιβάδες, μύδια, κρόκος Κοζάνης, σχοινόπρασο.',
    price: 21.5,
    image: 'https://images.unsplash.com/photo-1555949258-eb67b1ef0ceb?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Mains',
  ...
  },
  {
    ...
    nameEn: 'Briam (Greek Ratatouille)',
    nameEl: 'Μπριάμ',
    descriptionEn: 'Black olive biscuit, fresh herb oil, Epirus feta or vegan option and olive earth.',
    descriptionEl: 'Μπισκότο μαύρης ελιάς, λάδι φρέσκων μυρωδικών, φέτα Ηπείρου ή νηστίσιμη, χώμα ελιάς.',
    price: 13.5,
    image: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Mains',
  ...
  },
  {
    ...
    nameEn: 'Moussaka',
    nameEl: 'Μουσακάς',
    descriptionEn: 'Vegetable roll with beef mince, béchamel cream, Naxos graviera and aromatic Dodoni yogurt.',
    descriptionEl: 'Ρολό λαχανικών, μοσχαρίσιος κιμάς, κρέμα μπεσαμέλ, γραβιέρα Νάξου, γιαούρτι Δωδώνης.',
    price: 16.5,
    image: 'https://images.unsplash.com/photo-1628294895950-9805252327bc?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Mains',
  ...
  },
  {
    ...
    nameEl: 'Καλαμάρι Σχάρας',
    descriptionEn: 'Char-grilled squid with parsnip purée, bergamot caviar and layered onion textures.',
    descriptionEl: 'Πουρές παστινάκι, χαβιάρι μοσχολέμονο, υφές κρεμμυδιού.',
    price: 24,
    image: 'https://images.unsplash.com/photo-1559847844-5315695dadae?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Mains',
  ...
  },
  {
    ...
    nameEn: 'Cephalonia Sea Bream',
    nameEl: 'Τσιπούρα Κεφαλληνίας',
    descriptionEn: 'Filleted fresh sea bream from Cephalonia with baby vegetables and bisque sauce.',
    descriptionEl: 'Φιλεταρισμένη τσιπούρα, baby λαχανικά, σάλτσα μπισκ.',
    price: 24,
    image: 'https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Mains',
  ...
  },
  {
    ...
    nameEn: 'Chef-Smoked Tuna Fillet',
    nameEl: 'Τόνος Φιλέτο',
    descriptionEn: 'In-house smoked tuna with seasonal greens, beetroot salad and walnuts.',
    descriptionEl: 'Καπνισμένος από τον σεφ μας, χόρτα εποχής, παντζαροσαλάτα, καρύδι.',
    price: 26.5,
    image: 'https://images.unsplash.com/photo-1467003909585-2f8a72700288?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Mains',
  ...
  },
  {
    ...
    nameEn: 'Black Pork with Fig Honey',
    nameEl: 'Μαύρος Χοίρος - Συκόμελο',
    descriptionEn: 'Tender black pork with celery root purée, dried figs, walnuts and orange.',
    descriptionEl: 'Πουρέ σελινόριζας, αποξηραμένο σύκο, καρύδια, πορτοκάλι.',
    price: 19,
    image: 'https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Mains',
  ...
  },
  {
    ...
    nameEn: 'Filleted Lamb in Vine Leaf',
    nameEl: 'Αρνάκι Φιλεταρισμένο',
    descriptionEn: 'Tender lamb wrapped in vine leaf with lemon-oil foam and aromatic bulgur.',
    descriptionEl: 'Τυλιγμένο σε αμπελόφυλλο, αφρός λαδολέμονο, πλιγούρι με άρωμα γεμιστών.',
    price: 23,
    image: 'https://images.unsplash.com/photo-1603360946369-dc9bb6258143?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Mains',
  ...
  },
  {
    ...
    nameEn: 'Tagliata of Veal',
    nameEl: 'Ταλιάτα Μόσχου',
    descriptionEn: 'Premium sliced veal with crispy sweet potatoes and aged San Michalis from Syros.',
    descriptionEl: 'Τραγανές γλυκοπατάτες, Σαν Μιχάλη Σύρου.',
    price: 28.5,
    image: 'https://images.unsplash.com/photo-1432139555190-58524dae6a55?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Mains',
  ...
  // ΓΛΥΚΑ / DESSERTS
  {
    ...
    nameEl: 'Κρέμα Χαλβά',
    descriptionEn: 'Silky halva cream with lemon syrup, crushed almonds and vanilla ice cream.',
    descriptionEl: 'Σιρόπι λεμόνι, αμύγδαλο, παγωτό βανίλια.',
    price: 8.5,
    image: 'https://images.unsplash.com/photo-1551024601-bec78aea704b?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Desserts',
  ...
  },
  {
    ...
    nameEn: 'Gianniotiko',
    nameEl: 'Γιαννιώτικο',
    descriptionEn: 'White chocolate cream, ravani sponge, kaïmaki ice cream and rose petal preserve.',
    descriptionEl: 'Κρεμέ λευκής σοκολάτας, ραβανί, παγωτό καϊμάκι, γλυκό τριαντάφυλλο.',
    price: 10,
    image: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Desserts',
  ...
  },
  {
    ...
    nameEn: 'Vegan Chocolate Pie',
    nameEl: 'Σοκολατόπιτα Vegan',
    descriptionEn: 'Handcrafted vegan chocolate pie with homemade blackcurrant sauce.',
    descriptionEl: 'Χειροποίητη σάλτσα φραγκοστάφυλλο.',
    price: 10,
    image: 'https://images.unsplash.com/photo-1606313564200-e75d5e30476c?auto=format&fit=crop&q=80&w=800',
    category: 'guest',
    badgeEn: 'Desserts',
