...
export default function MenuSection({ lang }: MenuSectionProps) {
  ...
  const getWhatsAppLink = (item: MenuItem) => {
    ...
    const basePhone = '302103212858'; // Thes Phone Number
  ...
  return (
    <section id="menu" className="py-24 bg-[#070c18]/90 relative border-t border-[#d4af37]/10">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Tab Controls (Category selection buttons) */}
          ...
          <AnimatePresence mode="popLayout">
            {filteredItems.map((item, idx) => (
              <motion.div
                ...
                className="bg-[#091122] rounded-2xl overflow-hidden border border-[#d4af37]/10 flex flex-col h-full group"
              >
                ...
                <div className="relative aspect-[4/3] overflow-hidden bg-luxury-navy">
                  ...
                  {/* Standard Price Badge overlaying bottom right of image - food only */}
                  {activeTab === 'food' && (
